...
hidemeta: false
comments: true
description: "Retour d'expérience sur le développement d'un serveur OpenID Connect conforme FAPI 2.0 en Rust : architecture DDD, implémentation des flux sécurisés et documentation technique complète."
...
Le projet inclut une documentation détaillée en français et anglais. En attendant l'ouverture du repository GitHub pour la v1.0 (courant S1 2026), les documentations techniques sont **hébergées directement sur ce blog** :

### **Architecture & Stack**
📄 **[Documentation Technique (FR)](/docs/trusty/technical-fr/)** | **[Technical Documentation (EN)](/docs/trusty/technical-en/)**
...
### **Flux OIDC & FAPI 2.0**
📄 **[Documentation des Flux (FR)](/docs/trusty/oidc-flow-fr/)** | **[OIDC Flow Documentation (EN)](/docs/trusty/oidc-flow-en/)**
...
**Note** : JAR (JWT Secured Authorization Request) n'est pas dans cette liste car c'est déjà implémenté via le flux FAPI avec DPoP - les requêtes d'autorisation sont sécurisées via PAR avec validation de signature client.
...
- 📖 **[Documentation Technique (FR)](/docs/trusty/technical-fr/)** | **[(EN)](/docs/trusty/technical-en/)**
- 📖 **[Documentation Flux OIDC (FR)](/docs/trusty/oidc-flow-fr/)** | **[(EN)](/docs/trusty/oidc-flow-en/)**
- 🏠 **Repository GitHub** : Ouverture prévue avec la v1.0 (S1 2026)

## 🎉 **Conclusion**

Construire un serveur OIDC from scratch en Rust, c'est un sacré défi technique. Mais c'est aussi une opportunité d'**apprendre en profondeur** les mécanismes de sécurité modernes et de **reprendre le contrôle** sur l'authentification de vos applications.

**TRusTY n'est pas encore prêt pour la production** (c'est un MVP !), mais il démontre déjà qu'il est possible de construire un serveur OIDC performant, compréhensible et conforme aux standards les plus exigeants.
